...
public class IComponentDefinitions {
	...
	private static IComponentDefinitions[][] icomponentsdefs = new IComponentDefinitions[Utilities.getInterfaceDefinitionsSize()][];
	...
	public static IComponentDefinitions[] getInterface(int id) {
		...
		if (icomponentsdefs[id] == null) {
			icomponentsdefs[id] = new IComponentDefinitions[Utilities.getInterfaceDefinitionsComponentsSize(id)];
