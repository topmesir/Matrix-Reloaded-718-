...
public class Rest extends Action {
	...
	public boolean start(Player player) {
		...
		player.getContent().get(ContentType.APPEARANCE).setRenderEmote(REST_DEFS[index][1]);
		return true;
	}
	...
	public void stop(Player player) {
		...
		player.getContent().get(ContentType.EMOTES).setNextEmoteEnd();
		player.getContent().get(ContentType.APPEARANCE).setRenderEmote(-1);
	}
