package com.rs.game.entity.mobile.player.content.type.hint;
...
public class HintIconsManager extends AbstractContent {
	
	private transient HintIcon[] loadedIcons;

	public HintIconsManager() {
		loadedIcons = new HintIcon[7];
	}

	public int addHintIcon(MobileEntity target, int arrowType, int modelId, boolean saveIcon) {
