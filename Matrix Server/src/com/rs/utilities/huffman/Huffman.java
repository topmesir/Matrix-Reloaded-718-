package com.rs.utilities.huffman;
...
public final class Huffman {
	...
	public static int sendEncryptMessage(OutputStream stream, String message) {
		try {
			...
			byte[] messageData = Utilities.getFormatedMessage(message);
	...
	public static final String readEncryptedMessage(int maxLength, InputStream stream) {
		try {
			...
			String message = Utilities.getUnformatedMessage(messageDataLength, 0, messageData);
			return message;
		} catch (Throwable e) {
			return "";
		}
